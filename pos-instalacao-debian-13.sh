...
# Site: andre.poa.br
# Data: 18/03/2026
# Descrição: Script completo de pós-instalação para Debian 13
# ============================================================================
...
# ============================================================================
# 3. ADICIONAR REPOSITÓRIOS CONTRIB E NON-FREE
# ============================================================================

print_section "3. HABILITANDO REPOSITÓRIOS CONTRIB E NON-FREE"

print_message "Adicionando repositórios contrib e non-free..."
...
apt install -y ubuntu-restricted-extras 2>/dev/null || true
...
echo ""
print_message "Script de pós-instalação do Debian 13 concluído com sucesso!"
print_message ""
