...
# ============================================================================
# Script de Pós-Instalação - CentOS Stream 9
# ============================================================================
# Autor: André Kroetz Berger
# E-mail: andre@andre.poa.br
# Site: andre.poa.br
# Data: 18/03/2026
# Descrição: Script completo de pós-instalação para CentOS Stream 9
# ============================================================================
...
# ============================================================================
# 3. HABILITAR REPOSITÓRIOS EXTRAS
# ============================================================================

print_section "3. HABILITANDO REPOSITÓRIOS EXTRAS"

print_message "Habilitando repositórios CRB e EPEL..."
dnf config-manager --set-enabled crb
dnf install -y epel-release

print_message "Atualizando metadados..."
dnf update -y

# ============================================================================
# 4. INSTALAR MATE DESKTOP COM COMPIZ
# ============================================================================

print_section "4. INSTALANDO MATE DESKTOP E COMPIZ"
...
print_message "Instalando Compiz (se disponível)..."
dnf install -y compiz compiz-plugins-main compiz-plugins-extra 2>/dev/null || print_warning "Compiz pode não estar disponível no CentOS Stream 9"

# ============================================================================
# 5. ADICIONAR REPOSITÓRIOS RPM FUSION E FLATHUB
# ============================================================================

print_section "5. CONFIGURANDO REPOSITÓRIOS RPM FUSION"
...
dnf install -y --nogpgcheck https://download1.rpmfusion.org/nonfree/el/rpmfusion-nonfree-release-$(rpm -E %rhel).noarch.rpm
...
print_section "6. INSTALANDO CODECS MULTIMÍDIA"

print_message "Instalando codecs de áudio e vídeo..."
dnf install -y gstreamer1-plugins-{bad-\*,good-\*,base} gstreamer1-plugin-openh264 gstreamer1-libav --exclude=gstreamer1-plugins-bad-free-devel
dnf install -y lame\* --exclude=lame-devel
dnf groupupdate -y multimedia 2>/dev/null || true
...
# ============================================================================
# 7. SUPORTE A DVDS CRIPTOGRAFADOS
# ============================================================================

print_section "7. INSTALANDO SUPORTE A DVDS CRIPTOGRAFADOS"

print_message "Instalando libdvdcss..."
dnf install -y libdvdcss

# ============================================================================
# 8. FERRAMENTAS DE COMPRESSÃO
# ============================================================================

print_section "8. INSTALANDO FERRAMENTAS DE COMPRESSÃO"
...
print_section "9. INSTALANDO JAVA"
...
print_section "10. INSTALANDO SOFTWARES GERAIS"
...
pip3 install glances 2>/dev/null || dnf install -y glances
...
dnf install -y nautilus-dropbox 2>/dev/null || flatpak install -y flathub com.dropbox.Client
...
dnf install -y VirtualBox-7.0 kernel-devel kernel-headers dkms
...
dnf install -y handbrake handbrake-gui 2>/dev/null || flatpak install -y flathub fr.handbrake.ghb
...
print_section "11. INSTALANDO AMBIENTE DE DESENVOLVIMENTO"

print_message "Instalando Code::Blocks com GCC..."
dnf groupinstall -y "Development Tools"
dnf install -y gcc gcc-c++ make cmake
dnf install -y codeblocks codeblocks-contrib 2>/dev/null || print_warning "Code::Blocks pode não estar disponível, use Flatpak"
...
dnf install -y eclipse 2>/dev/null || flatpak install -y flathub org.eclipse.Java

print_message "Instalando MySQL Workbench..."
dnf install -y mysql-workbench 2>/dev/null || flatpak install -y flathub io.github.shiftey.Desktop
...
dnf install -y /tmp/github-desktop.rpm
...
print_section "12. INSTALANDO GAMES"
...
dnf install -y snes9x 2>/dev/null || flatpak install -y flathub com.snes9x.Snes9x
...
# ============================================================================
# 13. SERVIDOR (LAMP STACK + MONGODB)
# ============================================================================

print_section "13. INSTALANDO SERVIDOR LAMP + MONGODB"
...
print_section "14. CONFIGURAÇÕES FINAIS"
...
print_message "Configurando SELinux (se necessário)..."
...
echo ""
print_message "Script de pós-instalação do CentOS Stream 9 concluído com sucesso!"
print_message ""
...
print_message "  - Para iniciar o Compiz (se instalado), use: compiz --replace"
print_message "  - GitHub Desktop foi instalado em /tmp"
print_message "  - SELinux está habilitado - configure conforme necessário"
print_message ""
